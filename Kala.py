...
bot = telebot.TeleBot('6754493644:AAGBVPzJJuj-lB3QBFbVuzFk4Q2GFKrxjKg')
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @KaliaYtOwner ."
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 120:
                response = "Error: Buy From @KaliaYtOwner For More Time"
            else:
